...
async def chat_with_docs(req: ChatRequest):
    try:
        ...
        Instructions:
        1. Answer the user's question based STRICTLY on the Database Results provided below.
        2. The Database Results were generated by querying Neo4j based on the user's intent.
        3. If the Database Results contain an error or are empty, politely state: "I couldn't find the exact answer in the database using the generated search parameters."
        4. Format your answer beautifully using Markdown.
